"""
Extract drums MIDI files containing jazz-soul tags.
...
def app(msd_ids: List[str]):
  ...
  plt.title('Drums sequence length')
  plt.ylabel('Length of drums (sec)')
  plt.xlabel('Frequency')
  plt.savefig('drum-length-jazz.png')
